...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmRhYnJvd3NreSIsImEiOiJjbHl1YTAzZHgwN216MmlzYm1wZnNwdmM5In0.ObXnuvyuB9xewxMAs5kIfg';
...
},{}],"const.js":[function(require,module,exports) {
"use strict";
...
var API_URL = exports.API_URL = "http://127.0.0.1:8000/api/v1";
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          type = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'data';
          _context.prev = 1;
          url = type === 'password' ? "".concat(_const.API_URL, "/users/update-password") : "".concat(_const.API_URL, "/users/update-me");
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./const":"const.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51PffmYKhstXOJz6hN9LcH45r1fAaHa9Ax9PHZ8ltDWFYzqDXY0DI8LXeBV15DLo9NHHF5pK7ppAs3H0wErdaDNKu008bhqFPmh');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", (0, _alerts.showAlert)('error', 'Something went wrong, please try again later'));
        case 6:
          _context.next = 8;
...
var loginForm = document.querySelector('.login-form form.form');
var logoutButton = document.querySelector('a.nav__el.nav__el--logout');
var updateProfileForm = document.querySelector('form.form.form-user-data');
var changePasswordForm = document.querySelector('form.form.form-user-password');
var bookTourButton = document.querySelector('button#book-tour');
if (mapbox) {
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            currentPassword = e.target.querySelector('input#password-current').value;
            newPassword = e.target.querySelector('input#password').value;
            passwordConfirm = e.target.querySelector('input#password-confirm').value;
            if (newPassword !== passwordConfirm) {
              (0, _alerts.showAlert)('error', 'New password must be same as confirm password');
            }
            _context3.next = 7;
