 ...
 */
                        ...
                        case 0:
                          ...
                          url =
                            type === 'password'
                              ...
                              : ''.concat(_const.API_URL, '/users/update-me');
                          _context.next = 5;
                          return (0, _axios.default)({
                            method: 'PATCH',
                            url: url,
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var updateProfileForm = document.querySelector(
                    ...
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          password =
                            e.target.querySelector('input#password').value;
                          _context.next = 5;
                    ...
                    while (1)
                      switch ((_context2.prev = _context2.next)) {
                        case 0:
                          ...
                          form.append(
                            'email',
                            e.target.querySelector('input#email').value,
                          );
                          form.append(
                            'name',
                            e.target.querySelector('input#name').value,
                          );
                          form.append(
                            'photo',
                  ...
                  return _regeneratorRuntime().wrap(function _callee3$(
                    ...
                    while (1)
                      switch ((_context3.prev = _context3.next)) {
                        case 0:
                          e.preventDefault();
                          currentPassword = e.target.querySelector(
                            'input#password-current',
                          ).value;
                          newPassword =
                            e.target.querySelector('input#password').value;
                          passwordConfirm = e.target.querySelector(
        ...
        if (bookTourButton) {
          bookTourButton.addEventListener(
            'click',
            /*#__PURE__*/ (function () {
